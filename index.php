...
$("#name").on('change', function() {
  ...
  var name = this.value; //Get Username
  
  var todaydate = $("#date").val(); //Get Date
...
<div class="tab">
	...
	<div class="tab-widthtwo"><label style="width: 150px;">Fibre Rich
		...
		<input name="fibrerich[]" type="file" accept="image/x-png,image/gif,image/jpeg" data-type='image' multiple>
	</div>
	<div class="tab-width"><label>Protein rich
		<span class="points">(10 points)</span></label> 
		<input name="porteinrich[]" type="file" accept="image/x-png,image/gif,image/jpeg" data-type='image' multiple>
	</div>
	<div class="tab-width"><label>Water Content Food
		<span class="points">(10 points)</span></label>
		<input name="watercontentfood[]" type="file" accept="image/x-png,image/gif,image/jpeg" data-type='image' multiple>
	</div>
	<div class="tab-width"><label>Seasonal Fruits
		<span class="points">(10 points)</span></label>
		<input name="seasonalfruits[]" type="file" accept="image/x-png,image/gif,image/jpeg" data-type='image' multiple>
	</div>
</div>

<!-- Three "tab" for each step in the form: -->
<div class="tab">
	...
	<div class="tab-widthtwo"><p>Drinking water for their weight <span class="req">*</span></p>
		<label class="container">1.5 to 2 litres
			<input type="radio" name="waterliter" value="30">
			<span class="checkmark"></span>
		</label>
		<label class="container">2.1 to 5 litres
			<input type="radio" name="waterliter" value="50">
			<span class="checkmark"></span>
		</label>
		<button type="button" class="button"  onclick="clearSelection('waterliter');">
    	Clear Selection
  		</button>
	</div>
</div>

<!-- Four "tab" for each step in the form: -->
<div class="tab">
	<p class="sectiontwo">Activity</p>
	<div class="tab-widthtwo"><label>Sunlight (Morning / Evening)</label>
		<input name="moreve[]" type="file" accept="image/x-png,image/gif,image/jpeg" data-type='image' multiple>
	</div>
	...
	<div class="tab-width"><label>Activity Points</label>
		...
		<input placeholder="Enter your activity points" name="activitypoints">
	</div>
	<div class="tab-width"><label>Photo of Activity</label>
		<input name="photoactivity[]" type="file" accept="image/x-png,image/gif,image/jpeg" data-type='image' multiple>
	</div>
...
<div class="tab">
	...
	<div class="tab-width"><label>Steps - Image</label>
		<input name="stepscount[]" type="file" accept="image/x-png,image/gif,image/jpeg" data-type='image' multiple>
	</div>
</div>

<!-- Buttons for Back, Next Submit -->
<div class="buttonone">
	<div class="buttontwo">
